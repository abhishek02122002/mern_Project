...
function LinksDashboard() {
  ...
  const uploadToCloudinary = async (file) => {
    ...
    const formData = new FormData(); // padhna hai isko
  ...
  const columns = [
    {
        field:'thumbnail' , headerName:'Thumbnail',sortable:false,flex:1,renderCell:(params) => (
            params.row.thumbnail ? (
                <img src={params.row.thumbnail} alt="thumbnail" styles={{maxheight:'30px'}}/>
